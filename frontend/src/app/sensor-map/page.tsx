...
export default function SensorMapPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl p-6">
      <h1 className="mb-4 text-2xl font-bold">Sensor Map</h1>
      ...
      <div className="mb-4 flex flex-wrap gap-3">
        <div className="rounded-xl bg-blue-50 border border-blue-200 px-4 py-2 text-center">
          ...
          <div className="text-xs text-blue-600">Manual Sensors</div>
        </div>
        <div className="rounded-xl bg-green-50 border border-green-200 px-4 py-2 text-center">
          ...
          <div className="text-xs text-green-600">Road Sensors</div>
        </div>
      ...
      <div className="mb-4 flex gap-2">
        {[
          { key: "all" as const, label: "All Sensors", color: "bg-purple-600" },
          { key: "manual" as const, label: "Manual Only", color: "bg-blue-600" },
          { key: "road" as const, label: "Road Only", color: "bg-green-600" },
        ].map((filter) => (
          <button
            key={filter.key}
          ...
          >
            <Popup>
              <div className="text-sm">
                <strong>Manual Sensor</strong><br />
      ...
      <div className="mt-4 flex gap-4 text-xs text-gray-600">
        <div className="flex items-center gap-2">
          ...
          Manual Sensors ({manualCount})
        </div>
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 rounded-full bg-green-500" />
          Road Sensors ({roadCount})
        </div>
      </div>
    </div>
  );
