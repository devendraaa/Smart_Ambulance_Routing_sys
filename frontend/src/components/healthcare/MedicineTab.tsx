      ...
      {patientGroups.length === 0 ? (
        ...
        patientGroups.map((group) => {
          ...
          return (
            ...
            >
              {/* Patient header */}
              <div className={`px-6 py-4 flex items-center justify-between border-b ${allCollected ? "bg-emerald-50 border-emerald-200" : "bg-gray-50 border-gray-100"}`}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      {group.medicines.length} medicines · {activeCount} active
                ...
                <div className="flex items-center gap-2">
                  {allCollected ? (
                    <span className="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs font-medium flex items-center gap-1">
                      <CheckCircle2 className="w-3.5 h-3.5" /> All Collected
                    </span>
                  ) : collectedCount > 0 ? (
                      ...
                      >
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <div className="flex items-center gap-1.5 ml-2 shrink-0">
                            {med.medicine_collected && (
                              <span className="px-1.5 py-0.5 rounded text-xs bg-emerald-100 text-emerald-700 flex items-center gap-0.5">
